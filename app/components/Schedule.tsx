        ...
        <div className="overflow-x-auto pb-8">
          <div className="grid gap-6 sm:grid-cols-2 lg:flex lg:flex-nowrap lg:gap-0 lg:justify-start">
            {scheduleItems.map((item, index) => {
              const needsExtraShift = index >= 1 && index <= 4;
              return (
                <div
                  key={item.title}
                  ...
                  <div
                    className={`relative h-full rounded-2xl p-6 transition-all duration-300 sm:p-8 lg:rounded-none lg:pr-16 ${
                      index === 0
                        ...
                        : "lg:[clip-path:polygon(0_0,calc(100%_-_40px)_0,100%_50%,calc(100%_-_40px)_100%,0_100%,40px_50%)]"
                    } ${needsExtraShift ? "lg:pl-28" : "lg:pl-24"}`}
                    style={{
                  ...
                  >
                    <div
                      className={`relative z-10 flex h-full flex-col ${
                        needsExtraShift ? "lg:pl-6" : "lg:pl-4"
                      }`}
                    >
                      <div className="mb-4">
                        <span
                      ...
                      <h3
                        className="mb-3 text-[1.375rem] leading-tight text-white"
                        style={{ fontFamily: "SUITE Variable, sans-serif" }}
                      >
                        {item.title}
                      </h3>
                      ...
                      <p
                        className="mb-4 flex-grow text-sm text-white/90"
                        style={{ fontFamily: "Pretendard Variable, sans-serif" }}
                      >
                        {item.description}
                      </p>
